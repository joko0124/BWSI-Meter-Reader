...
'	Private Colore As Int = Colors.RGB(0,150,136)
	Private Colore As Int = GlobalVar.PriColor
...
private Sub FillCalendar
	...
	ButtonOk.TextColor = GlobalVar.PriColor
	...
	ButtoCancel.TextColor = Colors.Red
...
'	Pa.Color=Colors.ARGB(200,0,0,0)
	Pa.Color=Colors.ARGB(170,0,0,0)
...
Sub Pa_Touch (Action As Int, X As Float, Y As Float)
