...
Sub Activity_Create(FirstTime As Boolean)
	...
	Select GlobalVar.ReportLayout
		...
		Case "AverageBill"
			...
			iReportFlag = 4
	End Select
'	LoadLayoutToPanel(GlobalVar.ReportLayout)
	...
	DisplayRecords(GlobalVar.BranchID, GlobalVar.BillYear, GlobalVar.BillMonth, GlobalVar.UserID)
	If FirstTime Then
...
Sub btnHighBill_Click
	GlobalVar.ReportLayout = "HighBill"
End Sub

Sub btnLowBill_Click
	GlobalVar.ReportLayout = "LowBill"
End Sub

Sub btnZeroCons_Click
	GlobalVar.ReportLayout = "ZeroCons"
End Sub

Sub btnAveBill_Click
	GlobalVar.ReportLayout = "AverageBill"
End Sub
...
Private Sub DisplayRecords(iBranchID As Int, iBillYear As Int, iBillMonth As Int, iUserID As Int)
	Try
		...
		If rsMissCoded.RowCount > 0 Then
			...
			For i = 0 To rsMissCoded.RowCount - 1
				...
				CLV1.Add(CreateList(CLV1.AsView.Width, rsMissCoded.GetString("AcctNo"), rsMissCoded.GetString("AcctName"), rsMissCoded.GetString("AcctAddress"), rsMissCoded.GetString("BookNo"), rsMissCoded.GetString("SeqNo"), rsMissCoded.GetString("MeterNo"), rsMissCoded.GetInt("PresRdg"), rsMissCoded.GetInt("PrevRdg"), rsMissCoded.GetInt("PresCum"), rsMissCoded.GetString("Reason")),rsMissCoded.GetInt("ReadID"))
			Next
		Else
			Log(rsMissCoded.RowCount)
		End If
...
Sub btnExport_Click
	...
	DispInfoMsg($"Exporting feature was not yet ready..."$, $"SORRY... joko"$)
	Return
'	
