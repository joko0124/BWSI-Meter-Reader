...
anywheresoftware.b4a.keywords.Common.LogImpl("743974668",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
 //BA.debugLineNum = 191;BA.debugLine="Log($\"User Data \"$ & bRetVal)";
anywheresoftware.b4a.keywords.Common.LogImpl("743974671",("User Data ")+BA.ObjectToString(_bretval),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("743843633",("Server IP: ")+mostCurrent._globalvar._serveraddress /*String*/ ,0);
 //BA.debugLineNum = 134;BA.debugLine="Log($\"User ID: \"$ & GlobalVar.UserID)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843636",("User ID: ")+BA.NumberToString(mostCurrent._globalvar._userid /*int*/ ),0);
 //BA.debugLineNum = 135;BA.debugLine="Log($\"Employee Name: \"$ & GlobalVar.EmpName)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843637",("Employee Name: ")+mostCurrent._globalvar._empname /*String*/ ,0);
 //BA.debugLineNum = 136;BA.debugLine="Log($\"User Name: \"$ & GlobalVar.UserName)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843638",("User Name: ")+mostCurrent._globalvar._username /*String*/ ,0);
 //BA.debugLineNum = 137;BA.debugLine="Log($\"User Password: \"$ & GlobalVar.UserPW)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843639",("User Password: ")+mostCurrent._globalvar._userpw /*String*/ ,0);
 //BA.debugLineNum = 140;BA.debugLine="Log($\"Module 1: \"$ & GlobalVar.Mod1)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843642",("Module 1: ")+BA.NumberToString(mostCurrent._globalvar._mod1 /*int*/ ),0);
 //BA.debugLineNum = 141;BA.debugLine="Log($\"Module 2: \"$ & GlobalVar.Mod2)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843643",("Module 2: ")+BA.NumberToString(mostCurrent._globalvar._mod2 /*int*/ ),0);
 //BA.debugLineNum = 142;BA.debugLine="Log($\"Module 3: \"$ & GlobalVar.Mod3)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843644",("Module 3: ")+BA.NumberToString(mostCurrent._globalvar._mod3 /*int*/ ),0);
 //BA.debugLineNum = 143;BA.debugLine="Log($\"Module 4: \"$ & GlobalVar.Mod4)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843645",("Module 4: ")+BA.NumberToString(mostCurrent._globalvar._mod4 /*int*/ ),0);
 //BA.debugLineNum = 144;BA.debugLine="Log($\"Module 5: \"$ & GlobalVar.Mod5)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843646",("Module 5: ")+BA.NumberToString(mostCurrent._globalvar._mod5 /*int*/ ),0);
 //BA.debugLineNum = 145;BA.debugLine="Log($\"Module 6: \"$ & GlobalVar.Mod6)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843647",("Module 6: ")+BA.NumberToString(mostCurrent._globalvar._mod6 /*int*/ ),0);
 //BA.debugLineNum = 148;BA.debugLine="Log($\"Company ID: \"$ & GlobalVar.CompanyID)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843650",("Company ID: ")+BA.NumberToString(mostCurrent._globalvar._companyid /*int*/ ),0);
 //BA.debugLineNum = 149;BA.debugLine="Log($\"Branch ID: \"$ & GlobalVar.BranchID)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843651",("Branch ID: ")+BA.NumberToString(mostCurrent._globalvar._branchid /*int*/ ),0);
 //BA.debugLineNum = 150;BA.debugLine="Log($\"Branch Code: \"$ & GlobalVar.BranchCode)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843652",("Branch Code: ")+mostCurrent._globalvar._branchcode /*String*/ ,0);
 //BA.debugLineNum = 151;BA.debugLine="Log($\"Branch Name: \"$ & GlobalVar.BranchName)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843653",("Branch Name: ")+mostCurrent._globalvar._branchname /*String*/ ,0);
 //BA.debugLineNum = 152;BA.debugLine="Log($\"Branch Address: \"$ & GlobalVar.BranchAddres";
anywheresoftware.b4a.keywords.Common.LogImpl("743843654",("Branch Address: ")+mostCurrent._globalvar._branchaddress /*String*/ ,0);
 //BA.debugLineNum = 153;BA.debugLine="Log($\"Contact No.: \"$ & GlobalVar.BranchContactNo";
anywheresoftware.b4a.keywords.Common.LogImpl("743843655",("Contact No.: ")+mostCurrent._globalvar._branchcontactno /*String*/ ,0);
 //BA.debugLineNum = 154;BA.debugLine="Log($\"Tin No.: \"$ & GlobalVar.BranchTINumber)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843656",("Tin No.: ")+mostCurrent._globalvar._branchtinumber /*String*/ ,0);
 //BA.debugLineNum = 155;BA.debugLine="Log($\"Logo: \"$ & GlobalVar.BranchLogo)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843657",("Logo: ")+mostCurrent._globalvar._branchlogo /*String*/ ,0);
 //BA.debugLineNum = 156;BA.debugLine="Log($\"Meter Charges: \"$ & GlobalVar.WithMeterChar";
anywheresoftware.b4a.keywords.Common.LogImpl("743843658",("Meter Charges: ")+BA.NumberToString(mostCurrent._globalvar._withmetercharges /*int*/ ),0);
 //BA.debugLineNum = 157;BA.debugLine="Log($\"Franchised Tax: \"$ & GlobalVar.WithFranchis";
anywheresoftware.b4a.keywords.Common.LogImpl("743843659",("Franchised Tax: ")+BA.NumberToString(mostCurrent._globalvar._withfranchisedtax /*int*/ ),0);
 //BA.debugLineNum = 158;BA.debugLine="Log($\"Septage Fee: \"$ & GlobalVar.WithSeptageFee)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843660",("Septage Fee: ")+BA.NumberToString(mostCurrent._globalvar._withseptagefee /*int*/ ),0);
 //BA.debugLineNum = 159;BA.debugLine="Log($\"Disconnection Date: \"$ & GlobalVar.WithDisc";
anywheresoftware.b4a.keywords.Common.LogImpl("743843661",("Disconnection Date: ")+BA.NumberToString(mostCurrent._globalvar._withdiscondate /*int*/ ),0);
 //BA.debugLineNum = 160;BA.debugLine="Log($\"Septage Logo: \"$ & GlobalVar.SeptageLogo)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843662",("Septage Logo: ")+mostCurrent._globalvar._septagelogo /*String*/ ,0);
 //BA.debugLineNum = 161;BA.debugLine="Log($\"Septage Provider: \"$ & GlobalVar.SeptagePro";
anywheresoftware.b4a.keywords.Common.LogImpl("743843663",("Septage Provider: ")+BA.NumberToString(mostCurrent._globalvar._septageprov /*int*/ ),0);
 //BA.debugLineNum = 164;BA.debugLine="Log($\"Bill Year: \"$ & GlobalVar.BillYear)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843666",("Bill Year: ")+BA.NumberToString(mostCurrent._globalvar._billyear /*double*/ ),0);
 //BA.debugLineNum = 165;BA.debugLine="Log($\"Bill Month: \"$ & GlobalVar.BillMonth)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843667",("Bill Month: ")+BA.NumberToString(mostCurrent._globalvar._billmonth /*int*/ ),0);
 //BA.debugLineNum = 166;BA.debugLine="Log($\"Billing Period: \"$ & GlobalVar.BillPeriod)";
anywheresoftware.b4a.keywords.Common.LogImpl("743843668",("Billing Period: ")+mostCurrent._globalvar._billperiod /*String*/ ,0);
 //BA.debugLineNum = 167;BA.debugLine="Log($\"Bill Month Name: \"$ & GlobalVar.BillMonthNa";
anywheresoftware.b4a.keywords.Common.LogImpl("743843669",("Bill Month Name: ")+mostCurrent._globalvar._billmonthname /*String*/ ,0);
