...
public class badger extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.MeterReader.badger");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.MeterReader.badger.class).invoke(this, new Object[] {null});
        else
...
_radius = __c.DipToCurrent((int) (15));
 //BA.debugLineNum = 6;BA.debugLine="Private animationDuration As Int = 300";
...
_xlbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
 //BA.debugLineNum = 91;BA.debugLine="xlbl.Font = xui.CreateDefaultBoldFont(15)";
_xlbl.setFont(_xui.CreateDefaultBoldFont((float) (15)));
...
public ResumableSub_RemoveBadge(com.bwsi.MeterReader.badger parent,anywheresoftware.b4a.objects.B4XViewWrapper _view) {
this.parent = parent;
this._view = _view;
}
com.bwsi.MeterReader.badger parent;
...
public ResumableSub_ReplaceLabel(com.bwsi.MeterReader.badger parent,anywheresoftware.b4a.objects.B4XViewWrapper _view,int _badge) {
this.parent = parent;
this._view = _view;
this._badge = _badge;
}
