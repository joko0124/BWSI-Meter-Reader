...
private static modvariables mostCurrent = new modvariables();
public static Object getObject() {
    throw new RuntimeException("Code module does not support this method.");
}
 public anywheresoftware.b4a.keywords.Common __c = null;
public static njdude.fontawesome.lib.customfonts _sourcesansprobold = null;
public static njdude.fontawesome.lib.customfonts _sourcesansproregular = null;
...
public static String  _process_globals() throws Exception{
 ...
 //BA.debugLineNum = 4;BA.debugLine="Public SourceSansProBold As CustomFonts";
_sourcesansprobold = new njdude.fontawesome.lib.customfonts();
 //BA.debugLineNum = 5;BA.debugLine="Public SourceSansProRegular As CustomFonts";
_sourcesansproregular = new njdude.fontawesome.lib.customfonts();
