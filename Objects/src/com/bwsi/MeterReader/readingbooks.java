...
anywheresoftware.b4a.keywords.Common.LogImpl("753149700",BA.NumberToString(mostCurrent._globalvar._bookid /*int*/ ),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("753018652",BA.NumberToString(mostCurrent._rsassignedbooks.getRowCount()),0);
 };
 } 
       catch (Exception e14) {
			processBA.setLastException(e14); //BA.debugLineNum = 149;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("753018655",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
