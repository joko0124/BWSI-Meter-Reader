...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.MeterReader.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.MeterReader.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.bwsi.MeterReader.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new com.bwsi.MeterReader.anotherprogressbar();
...
public ResumableSub_Show(com.bwsi.MeterReader.b4xtimedtemplate parent,com.bwsi.MeterReader.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.bwsi.MeterReader.b4xtimedtemplate parent;
