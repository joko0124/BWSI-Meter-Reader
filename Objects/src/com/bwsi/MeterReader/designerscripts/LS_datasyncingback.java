...
public class LS_datasyncingback{
...
views.get("lblmeterreader").vw.setLeft((int)((3d / 100 * width)));
views.get("pnlreaderul").vw.setTop((int)((views.get("lblmeterreader").vw.getTop())));
views.get("pnlreaderul").vw.setLeft((int)((views.get("lblmeterreader").vw.getLeft() + views.get("lblmeterreader").vw.getWidth())));
views.get("pnlreaderul").vw.setWidth((int)((views.get("pnldownload").vw.getWidth())-(3d / 100 * width) - ((views.get("lblmeterreader").vw.getLeft() + views.get("lblmeterreader").vw.getWidth()))));
...
//BA.debugLineNum = 110;BA.debugLine="cboReaderUpload.SetLeftAndRight(lblReaderULIcon.Right + 3dip, pnlReaderUL.Width - 1%x)"[DataSyncingBack/General script]
...
//BA.debugLineNum = 111;BA.debugLine="cboReaderUpload.SetTopAndBottom(0.5%y, pnlReaderUL.Height - 0.5%y)"[DataSyncingBack/General script]
...
//BA.debugLineNum = 114;BA.debugLine="btnCancelUpload.SetTopAndBottom(pnlReaderUL.Bottom + 10dip, pnlUpload.Height - 10dip)"[DataSyncingBack/General script]
...
//BA.debugLineNum = 115;BA.debugLine="btnCancelUpload.SetLeftAndRight(5%x, pnlUpload.Width - 63%x)"[DataSyncingBack/General script]
...
//BA.debugLineNum = 117;BA.debugLine="btnOkUpload.SetTopAndBottom(pnlReaderUL.Bottom + 10dip, pnlUpload.Height - 10dip)"[DataSyncingBack/General script]
...
//BA.debugLineNum = 118;BA.debugLine="btnOkUpload.SetLeftAndRight(pnlUpload.Width - 35%x, pnlUpload.Width - 3%x)"[DataSyncingBack/General script]
