...
views.get("months").vw.setWidth((int)((views.get("toppanel").vw.getWidth())-(45d / 100 * width) - ((2d * scale))));
views.get("lblselectedday").vw.setLeft((int)((views.get("months").vw.getLeft() + views.get("months").vw.getWidth())+(2d * scale)));
views.get("lblselectedday").vw.setWidth((int)((views.get("toppanel").vw.getWidth())-(35d / 100 * width) - ((views.get("months").vw.getLeft() + views.get("months").vw.getWidth())+(2d * scale))));
...
views.get("btntoday").vw.setTop((int)((views.get("base").vw.getHeight())-(5d * scale) - (views.get("btntoday").vw.getHeight())));
views.get("btncancel").vw.setTop((int)((views.get("base").vw.getHeight())-(5d * scale) - (views.get("btncancel").vw.getHeight())));
