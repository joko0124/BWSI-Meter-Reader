...
__c.LogImpl("416580613","rastering bitmap: width="+BA.NumberToString(_mybitmap.getWidth())+" height="+BA.NumberToString(_mybitmap.getHeight()),0);
...
__c.LogImpl("416646150","rastering2 bitmap: width="+BA.NumberToString(_mybitmap.getWidth())+" height="+BA.NumberToString(_mybitmap.getHeight()),0);
...
__c.LogImpl("416711686","rastering2 bitmap: width="+BA.NumberToString(_mybitmap.getWidth())+" height="+BA.NumberToString(_mybitmap.getHeight()),0);
