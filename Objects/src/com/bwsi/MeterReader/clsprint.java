...
__c.LogImpl("142008581","rastering bitmap: width="+BA.NumberToString(_mybitmap.getWidth())+" height="+BA.NumberToString(_mybitmap.getHeight()),0);
...
__c.LogImpl("142074118","rastering2 bitmap: width="+BA.NumberToString(_mybitmap.getWidth())+" height="+BA.NumberToString(_mybitmap.getHeight()),0);
...
__c.LogImpl("142139654","rastering2 bitmap: width="+BA.NumberToString(_mybitmap.getWidth())+" height="+BA.NumberToString(_mybitmap.getHeight()),0);
