...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.MeterReader.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.MeterReader.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.bwsi.MeterReader.b4xfloattextfield _searchfield = null;
...
_pnlcolor = _customlistview1._defaulttextbackgroundcolor;};
 //BA.debugLineNum = 139;BA.debugLine="Dim cs As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 140;BA.debugLine="cs.Initialize.Append(item.SubString2(0, x)).Colo";
_cs.Initialize().Append(BA.ObjectToCharSequence(_item.substring((int) (0),_x))).Color(_texthighlightcolor).Append(BA.ObjectToCharSequence(_item.substring(_x,(int) (_x+_full.length())))).Pop();
 //BA.debugLineNum = 141;BA.debugLine="cs.Append(item.SubString(x + full.Length))";
_cs.Append(BA.ObjectToCharSequence(_item.substring((int) (_x+_full.length()))));
 //BA.debugLineNum = 142;BA.debugLine="If ItemsCache.Size > 0 Then";
...
_p.GetView((int) (0)).setText(BA.ObjectToCharSequence(_cs.getObject()));
 //BA.debugLineNum = 151;BA.debugLine="p.Color = pnlColor";
_p.setColor(_pnlcolor);
 //BA.debugLineNum = 152;BA.debugLine="CustomListView1.Add(p, item)";
_customlistview1._add(_p,(Object)(_item));
 }else {
 //BA.debugLineNum = 154;BA.debugLine="CustomListView1.AddTextItem(cs, item)";
...
_searchfield = new com.bwsi.MeterReader.b4xfloattextfield();
...
__c.LogImpl("975956257","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(com.bwsi.MeterReader.b4xsearchtemplate parent,com.bwsi.MeterReader.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.bwsi.MeterReader.b4xsearchtemplate parent;
...
parent._searchfield._gettextfield /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().RequestFocus();
 //BA.debugLineNum = 75;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
